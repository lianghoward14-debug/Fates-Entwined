  ...
  function documentTwoPages(){
    return [
      ...
      },
      {
        ...
        summary:'Kvetka Svoboda grows from Sebastyen Janowicz\'s adopted daughter in Wodny Potok into the Bohemian Queen of Czechoslovakia, balancing family loyalty, politics, and careful resistance to militarization.',
        body:'Kvetka Svoboda was adopted from a Prague orphanage by Sebastyen Janowicz alongside Rozsi and Zsofia Szocs, then raised in Wodny Potok with Felicyta Janowicz. She became especially close to Felicyta, sharing walks, secrets, snow, village life, fishing trips with Wojciech, and an infamous childhood talent for terrible ukulele playing.\n\nSebastyen intended Kvetka to become Czechia\'s future leader, giving her the same world class education as the rest of the household. She attended Charles University in 2025, became a senator\'s aide, and rose through ANO 2011 as a sharp administrator. After the senator age threshold was lowered, she won District 6 in Prague in 2029 and became known for strong education policy.\n\nWhen monarchist currents spread beyond Sebastyen\'s original plans, Kvetka was pushed into public myth through the film The Bohemian Queen. Though uncomfortable with how much her father controlled her image, she endured it for the family. By the 2040s, as her siblings rose into their planned positions and disagreements over militarization deepened, Kvetka tried to hold a neutral, pragmatic line while quietly leaning toward Felicyta\'s caution.',
...
Eventually after the West Canadian front had stabilized, the 1st US Marines were taken to the European theater, where they conducted two naval landings in Germany before being redeployed to the Pacific in 2053. In tandem with the now revitalized US Navy, the 1st US Marines were a key asset in the Aleutian campaign and the Kamchatka campaign, creating brief but devastating breakthroughs within minutes of deploying from their landing crafts and allowing scores of other regiments to flood in. Their greatest challenge came in the Invasion of Vladivistok, where they took upon an extremely fortified position on Russkiy Island, lined with dozens of forts and a thick line of three Russian regiments, nestled behind a line of trees. Recalling their very first victory also against three regiments on Stuart’s Island, the regiment initiated a daring maneuver where they drastically loosened the formation, only to at the last minute quickly funnel back in to make a breakthrough, despite being showered on the flanks from the other two Russian regiments. After the victory at Vladivistok, the 1st US Marines would be continuously deployed in the Pacific until 2054, when they would begin a short campaign in China.`,
    ...
    'kvetka-svoboda': `Kvetka Svoboda was brought to an orphanage in Prague when both her father and mother abandoned her at a young age, staying until the age of seven until she was adopted by Sebastyen Janowicz alongside Rozsi, and Zsofia Szocs. Kvetka met Felicyta Janowicz for the first time at this moment, and would grow exceptionally close to her over the course of their childhood.

Kvetka moved to Wodny Potok, a small mountain village in the Carpathian Mountains. Life in Wodny Potok, although uneventful, was quaint and idyllic - Kvetka in particular enjoyed hiking through the mountain forests, playing in the snow, and talking to the villagers of Wodny Potok. She would accompany the family housekeeper, Wojciech, on fishing trips frequently and together they would bring back scores of Brown Trout in order to cook for the night’s dinner. Kvetka loved talking to her sister Felicyta, and together they would go around long walks in the town. They often shared secrets with one another and participated in all manner of activities together, whether it was watching T.V, studying, or having a snack at the kitchen counter. She often would try to encourage Felicyta to find some hobbies of her own so that she wasn’t just studying for most of the day, but this was to no avail. Regardless she was incredibly supportive of Felicyta, often taking care of her whenever she was sick. One of Kvetka’s main hobbies during her childhood was playing the ukulele, which she was infamously very poor at it - she was dubbed the Demon of the Ukulele by her siblings.

However, due to the high expectations of their father, Sebastian Janowicz, who was the leader of Visegrad during this time period, Kvetka spent a large chunk of her time being homeschooled by private tutors, given a world class education. Kveka was often sent away to participate in extra curricular activities like debates, conferences, and educational excursions around the world, as a means to boost her achievements from a young age. As it turns out, Sebastian intended for the four siblings to eventually take the mantle as Monarchs or leaders for each of the respective nations, and in this case Kvetka was expected to become the President of the Czech Republic.

For college, Kvetka attended Charles University in the year 2025. Shortly after graduating, she was granted a position as a senator’s aide, working in politics for the next few years. Whereas her siblings Rozsi and Zsofia were to rely on their heritage as being descendants of a great Hungarian king to be propelled into fame, Kvetka had to be guided through the political ladder in order to achieve the same status. Her senator appointment was one of the most recognizable politicians in the country, known for his defiance of political opponents, ability to judge the economic situation of the country well, and having guided the country through the 2027 Silicon Valley Crash. She worked hard to prove her capabilities, and was praised by the senator for her efforts and clear intelligence. Hence Kvetka became a notable figure in the ANO 2011 party, a right wing populist movement, and continued to handle administrative tasks and coordination for the next several years. In 2029, when the senator age threshold was lowered to 22, thanks in part to some political maneuvering on Sebastyen’s part, Kvetka was able to run for senator and win in 2029, representing District 6 in Prague. She would enact strong policies around Education, dramatically improving test scores around her district and increasing student happiness. The Czech Technical College in district 6 rose dramatically in ranking during this time, moving from #400 to the #98.

Initially, Sebastyen had planned for Kvetka to become the President of Czechia, and her current trajectory reflected that. However, Sebastyen’s nurtured Monarchist movement in Hungary and Poland achieved unexpected success even abroad, fairly unintentionally, and Czechia found itself well within the currents of that movement. Recognizing that their strategy had to change, but also not to fall back on a glorious lineage like in Hungary, Sebastyen devised a scheme to propel Kvetka into the conversation in 2035. Hiring the best screenwriters and filmmakers in Europe, he commissioned a movie called “The Bohemian Queen”, utilizing Kvetka’s exceptionally good looks as a means to make her a movie star. Kvetka, although generally open to such experiences, was not fond of her father controlling her life to this extent, and forcing her to become a movie star against her will. However, not wanting to create family friction, Kvetka beared with the process and tried to not think too hard about it, announcing her retirement from her senator position. In the release of the movie, timed with large, Pro-Monarchism marches in Poland and Hungary, and having circulated widely some of Kvetka’s exceptional achievements in college, as a senator, and in her childhood, one question floated around popular discourse after the movie was released - “Wouldn’t she make a good queen in real life?

From this point onwards, Sebastyen helped launch massive Monarchist Marches in Prague, centered around the conversation of making Kvetka the Bohemian Queen. Unintentionally during this time, interest in creating a united Czechoslovak nation also soared. In 2037, after having developed enough momentum, a referendum was held in both Czechia and Slovakia, resulting in the Declaration of a Monarchy, one in which would be chosen by the people. Kvetka naturally made the conversation, and after a long series of political maneuvers in which discredited her opponents, Kvetka won the bid and became The Bohemian Queen in August 18th, 2037.

Kvetka’s domestic policies centered around the continuous expansion of Education and tackling inflation. Over the course of the next eight years, three Czech Universities would make it into the top 100 of world rankings when there had been none even in the top 200, and secondary and postsecondary education was reinforced with a revitalized curriculum devised by Kvetka herself. Titled the “Svoboda Method,” she drew upon the brilliant tutors in her youth to help map a more comprehensive curriculum that encouraged creative thinking and philosophy more strongly than before. Drawing upon the lessons of the senator she had worked under, she managed to stem inflation down to a respectable level thanks to the careful management of energy resources. In the international sphere however, Kvetka found herself in a difficult position. By 2045, all of her siblings had ascended into their planned positions - Felicyta as Queen of Poland, and Rozsi and Zsofia as the twin monarchs of Hungary. Sebastyen had begun aging during this time, and played less of a role in Visegrad politics. As a result, disagreements ensued over the siblings, particularly with Felicyta and Zsofia on the topic of militarization. Kvetka took a neutral stance, but generally sided with Felicyta internally - she did not pursue policy that would encourage militarization for most the decade, but was aware of the precarious state of tension in Europe. It was not until 2051 when Kvetka would order some form of militarization, when it became glaringly obvious that conflict was looming, and it became a necessity to make some form of military preparation as a way to pacify the concerns of the population.

At the outbreak of the Third Great War, Kvetka remained in Prague for the duration of her country's five month resistance against the Comintern forces, although she was not known to be a particularly encouraging leader. Rather she focused on maintaining the stability of the country so that collapse did not occur, ensuring that resources were distributed accordingly so that theft and starvation did not occur despite encirclement. Her War Rations act in January of 2052 properly allocated foodstuff so that the military were able to maximize the amount of food they had access to, while making sure civilians were not malnourished. It also maximized the production of the most amount of crops with as little land as possible, establishing the bare minimum for a healthy amount of diversity. Kvetka explicitly did not want to engage in any form of siege warfare and so she advocated for the construction of fortifications around Prague as a main system of defense for the oncoming invasion. When Czechoslovakia inevitably fell in May of 2052, Kvetka’s government moved to New York in exile. From exile she would continue her mediation between Felicyta and Zsofia, focusing on bringing them back together.`,
...
Zimbabwean Honour Guard Affiliation; The African Union DOB: None Place of Birth: None Story: The Third Great War and Events Preceding Titles: The Horns of the Buffalo Relations: Shaka Zulu II

In the 19th century, the Zulu armies were famous for their "buffalo horns" strategy, consisting of the chest, horns, and loins formation, which revolutionized warfare during the era. The chest consisted of veteran forces that pinned the enemy in place and met the opposing formation head-on. The horns were made up of faster, younger warriors who could rapidly maneuver around the enemy and encircle them, while the loins acted as a reserve force.
...
Kazumi Affiliation; None DOB: Unknown Place of Birth: Unknown, presumably Colombo Story: To Eventide Titles: None Relations: Anicka Konvicka`
  };
