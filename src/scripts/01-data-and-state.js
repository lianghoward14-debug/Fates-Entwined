...
const CARDS = [
  ...
  {id:'02',name:'Anicka Konvicka',ability:'The Starlit Path',type:'Initiator',aff:'eventide',
    ...
    effect:'Create an extra safe row for yourself in this zone. Any card placed in this zone gains 5 Fate.',
  ...
  {id:'40',name:'Christopher Erbs',ability:'Hard Times, Strong Men',type:'Improvisor',aff:'expanded_worlds',
    fate:6,cost:2,rarity:'triangle',
    effect:'At any time during your own turn, you can activate this effect; the next card you draw gains 4 Fate (2 uses).',
