...
const CARDS = [
  ...
  {id:'87',name:'Kv\u011btka Svoboda (Ukulele)',ability:'A Noble Effort at a Ballad',type:'Initiator',aff:'expanded_worlds',
    fate:4,cost:2,rarity:'triangle',
    effect:'Starting your next turn, if you would consolidate at least once and not set a Supporter, all of your consolidations that turn gain 4 Fate permanently at the end of the turn. This effect ends when you set a Supporter.',
  ...
  {id:'92',name:'Wodny Potok Lumberjack',ability:'Wood for the Hearth',type:'Supporter',aff:'expanded_worlds',
    fate:1,cost:0,rarity:'circle',
    effect:'While this card is on the field, any other Supporter you set in this zone has its effect negated or suppressed, but gains 1 Reinforcement.',
