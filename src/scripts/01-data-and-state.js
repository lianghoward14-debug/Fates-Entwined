...
const CARDS = [
  ...
  {id:'bh13',name:'Hugh Roberts',ability:'Smart Investments',type:'Initiator',aff:'expanded_worlds',
    ...
    effect:'Send up to three cards in your hand to the discard pile—each of those cards permanently gains 6 Fate.',
    flavor:'"He\'s slimy, shady, and unapologetically self-interested—the perfect type of man to run the finances of your top secret military facility in the Alps"',img:'bh13.png'},
