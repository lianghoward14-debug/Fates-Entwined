...
const CARDS = [
  ...
  {id:'36',name:'Marie L\'amboure',ability:'Deterrance',type:'Improvisor',aff:'third_great_war',
    fate:6,cost:2,rarity:'triangle',
    effect:'Whenever your opponent would Consolidate a card in this zone, reduce the zone\'s total Fate by 3.',
  ...
  {id:'52',name:'The Vigilantes',ability:'Expendable Justice',type:'Supporter',aff:'eventide',
    fate:1,cost:0,rarity:'circle',
    effect:'Once per turn, expend 3 other friendly Supporters to destroy a card in this zone.',
