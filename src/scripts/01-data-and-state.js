...
const CARDS = [
  ...
  {id:'bh10',name:'Francisek',ability:'Chauffeur',type:'Initiator',aff:'expanded_worlds',
    fate:1,cost:1,rarity:'square',set:'brave_horizons',
    effect:'Discard your entire hand then draw an equal number of cards from your deck.',
    flavor:'"A reliable chauffeur for the Janowicz family"',img:'bh10.png'},
