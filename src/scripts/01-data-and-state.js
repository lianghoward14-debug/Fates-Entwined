...
const CARDS = [
  ...
  {id:'bh07',name:'Agent-K',ability:'Overclock',type:'Coordinator',aff:'expanded_worlds',
    ...
    flavor:'"A prodigious talent in hacking and code breaking"',img:'bh7.png?v=20260723a'},
  {id:'bh08',name:'Maja Kaminska (University)',ability:'Mischievous Activities',type:'Coordinator',aff:'expanded_worlds',
    ...
    flavor:'"We shall draw silly faces on the Palace of Science and Culture"',img:'bh8.png?v=20260723a'},
  ...
  {id:'bh16',name:'Li-Hua (Battle-Ready)',ability:'Storm of Ten Thousand Blades',type:'Improvisor',aff:'eventide',
    ...
    flavor:'"A furious dragon, amidst a raging typhoon—such is the impression left by Li-Hua\'s peerless bladework"',img:'bh16.png?v=20260824b'},
  {id:'bh17',name:'Jakob Eltzholtz',ability:'Crushing Momentum',type:'Improvisor',aff:'expanded_worlds',
    ...
    effect:'When you would consolidate a card while you have more total Fate than your opponent, that card gains 3 Fate.',
    flavor:'"The only time I felt genuine sadness in my entire life...was when those zombies tore down my Siggy\'s!"',img:'bh17.png?v=20260824a'},
  {id:'bh18',name:'Jimmy (Post-Cynthia Hug)',ability:'The Genesis of all Inceldom',type:'Improvisor',aff:'reality',
    ...
    effect:'When your opponent would end their turn, discard a random card from their deck.',
    flavor:'"In that fleeting moment with Cynthia, at the pinnacle of his entire existence...Jimmy seethed."',img:'bh18.png?v=20260824a'},
  ...
  {id:'bh21',name:'Oktai',ability:'The Vast Taklamakan',type:'Initiator',aff:'expanded_worlds',
    ...
    effect:'Starting on your opponent\'s next turn and lasting for four of their turns, they cannot see field Fate values, zone Fate values, either player\'s Morale, either player\'s hand count, the turn timer, or the numerical amount of any Morale gain or loss.',
    flavor:'"The Taklamakan is vast and unforgiving - just like my ex-wife"',img:'bh21.png?v=20260830c'},
...
const LANDSCAPES = {
  ...
  igb2: {
    ...
    description:'Whichever player has consolidated more times by the end of turn 14 gains 12 Fate in any zone they choose.'
  },
  igb3: {
    id:'igb3',
