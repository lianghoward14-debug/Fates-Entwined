...
const CARDS = [
  ...
  {id:'02',name:'Anicka Konvicka',ability:'The Starlit Path',type:'Initiator',aff:'eventide',
    fate:7,cost:3,rarity:'star',
    effect:'Create an extra safe row for yourself in this zone. Any card placed in this zone gains 3 Fate.',
  ...
  {id:'05',name:'17th British Regiment of Africa',ability:'Liberators of Rwanda',type:'Supporter',aff:'third_great_war',
    ...
    effect:'When set, select one card in this card\'s zone; it gains 2 Fate permanently.',
  ...
  {id:'11',name:'Anne Stone',ability:'Coordination',type:'Coordinator',aff:'eventide',
    fate:3,cost:2,rarity:'triangle',
    effect:'All Supporters you control in this zone gain 2 Fate.',
  ...
  {id:'24',name:'Ralph\'s Courtesy Clerk',ability:'"Make it Right"',type:'Supporter',aff:'reality',
      fate:1,cost:0,rarity:'circle',
      effect:'When you Consolidate onto a card in a square adjacent to this card, that Consolidation costs 1 less reinforcement.',
  ...
  {id:'31',name:'Oathbound Noble Fighter',ability:'Hemorrhaging Wound',type:'Supporter',aff:'eventide',
    fate:1,cost:0,rarity:'circle',
    effect:'When set, select one card in this card\'s zone; it loses 2 Fate permanently.',
  ...
  {id:'34',name:'Rozsi Szocs',ability:'Hungarian Dance',type:'Coordinator',aff:'third_great_war',
    fate:3,cost:2,rarity:'triangle',
    effect:'Whenever a card would move into this card\'s zone by any effect, it permanently gains 2 Fate. Setting a card does not count.',
  ...
  {id:'36',name:'Marie L\'amboure',ability:'Deterrance',type:'Improvisor',aff:'third_great_war',
    ...
    effect:'Whenever your opponent would Consolidate a card in this zone, reduce the zone\'s total Fate by 2.',
  ...
  {id:'37',name:'6th French Fusiliers',ability:'The Anchor of Verdun',type:'Supporter',aff:'third_great_war',
    ...
    flavor:'"The 6th Fusiliers, surrounded at Verdun, held off the Soviet advance for eighty-five days before breaking out"',img:'37.png'},
  {id:'38',name:'Jake',ability:'I\'m Fat',type:'Dauntless',aff:'reality',
    fate:1,cost:3,rarity:'triangle',
    effect:'Once a turn, you can send a Supporter from your hand to the discard to permanently increase this card\'s Fate by 3.',
  ...
  {id:'40',name:'Christopher Erbs',ability:'Hard Times, Strong Men',type:'Improvisor',aff:'expanded_worlds',
    fate:4,cost:2,rarity:'triangle',
    effect:'Each time you would draw a card, you may activate this effect; the next card you draw gains 4 Fate (2 uses).',
  ...
  {id:'44',name:'Soviet Grenadiers',ability:'The Bears of Russia',type:'Supporter',aff:'third_great_war',
    fate:1,cost:0,rarity:'circle',
    effect:'While this card is adjacent to a Dauntless card, both that card and this card gains 2 Fate.',
  ...
  {id:'47',name:'Great Oak Infantry',ability:'"We Bleed Red"',type:'Supporter',aff:'expanded_worlds',
    fate:1,cost:0,rarity:'circle',
    effect:'When this card would be used in the Consolidation of a card, that card gains 2 Fate permanently.',
  ...
  {id:'52',name:'The Vigilantes',ability:'Marked for Death',type:'Supporter',aff:'eventide',
    fate:1,cost:0,rarity:'circle',
    effect:'When set, select a supporter your opponent controls in this zone - Make its Reinforcement value 0.',
  ...
  {id:'54',name:'Wolf Creek Light Infantry',ability:'Elusive Movements',type:'Supporter',aff:'expanded_worlds',
    fate:1,cost:0,rarity:'circle',
    effect:'When set, select one character you control in this zone and move it to any open square in any zone you control.',
  ...
  {id:'56',name:'Lydia',ability:'Berknomaly!?@#',type:'Improvisor',aff:'expanded_worlds',
    ...
    effect:'Whenever your opponent would activate the effect of a Supporter, you can negate or suppress the effect permanently (5 uses).',
  ...
  {id:'63',name:'Greek Hoplite',ability:'Sons of Macedon',type:'Supporter',aff:'third_great_war',
    fate:1,cost:0,rarity:'circle',
    effect:'This card gains 1 Fate for each copy of this card you control in this zone.',
  ...
  {id:'64',name:'Cook Islands Duelist',ability:'Blade Dance',type:'Supporter',aff:'eventide',
    fate:1,cost:0,rarity:'circle',
    effect:'When set, select a card adjacent or diagonal to this card; change its Fate value to this card\'s current Fate value, excluding Dauntless cards.',
  ...
  {id:'65',name:'1st West Caribbea Marines',ability:'Sea-Men',type:'Supporter',aff:'eventide',
    ...
    effect:'This card can only be set in contested rows. While on the field, this card gains 2 Fate.',
...
const LANDSCAPES = {
  ...
  igb14: {
    ...
    description:'Turn timers are reduced to 20 seconds.'
  },
  igb15: {
    id:'igb15',
