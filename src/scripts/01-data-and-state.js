...
const CARDS = [
  ...
  {id:'01',name:'Felicyta Janowicz',ability:'The White Eagle',type:'Coordinator',aff:'third_great_war',
    fate:6,cost:3,rarity:'square',effectClass:'ADJACENCY_BONUS',
  ...
  {id:'04',name:'Zoe',ability:'INTJ Stare',type:'Initiator',aff:'reality',
    ...
    effect:'Select one square in this card\'s zone; your opponent\'s cards on that square cannot leave the field.',
    flavor:'"She\'s definitely Caitlyn\'s mom"',img:'4.png?v=20260830b'},
  ...
  {id:'14',name:'Alondra Hopkins',ability:'Unseen Strikes',type:'Dauntless',aff:'eventide',
    fate:14,cost:4,rarity:'triangle',
  ...
  {id:'15',name:'Zsofia Szocs',ability:'Blue Danube Waltz',type:'Coordinator',aff:'third_great_war',
      ...
      flavor:'"The Beautiful Danube, clear and blue"',img:'15.png?v=20260723a'},
  ...
  {id:'18',name:'1st US Marines',ability:'Semper Fidelis',type:'Supporter',aff:'third_great_war',
    ...
    flavor:'"The de-facto shock troops of America - Loyal, brave, and true"',img:'18.png?v=20260907-marines'},
  ...
  {id:'20',name:'South Wind Spearman',ability:'Shield Wall',type:'Supporter',aff:'eventide',
    ...
    flavor:'"In Pacifica, the South Wind Spearmen are the textbook definition of a disciplined and well organized army"',img:'20.png?v=20260830a'},
  ...
  {id:'31',name:'Oathbound Noble Fighter',ability:'Hemorrhaging Wound',type:'Supporter',aff:'eventide',
    fate:1,cost:0,rarity:'circle',
    effect:'When set, select any card in this card\'s zone; it loses 4 Fate permanently.',
    flavor:'"These mercenaries fight not for money, but for the thrill of battle"',img:'31.png?v=20260909-four'},
  ...
  {id:'34',name:'Rozsi Szocs',ability:'Hungarian Dance',type:'Coordinator',aff:'third_great_war',
    fate:4,cost:2,rarity:'triangle',
    effect:'Declare an affiliation—all cards you control in this zone with that affiliation inflict 3 Morale Damage every Morale Calculation.',
    flavor:'"Rozsi\'s charisma counterparts his sister\'s administrative abilities. Together, the Twin Monarchs are a capable duo"',img:'34.png?v=20260909-balance'},
  ...
  {id:'37',name:'6th French Fusiliers',ability:'The Anchor of Verdun',type:'Supporter',aff:'third_great_war',
    fate:1,cost:0,rarity:'circle',
    effect:'When set, select any Supporter on the field with a "While this card is on the field" effect, or Wodny Potok Youth, and copy that effect for this card.',
  ...
  {id:'40',name:'Christopher Erbs',ability:'Hard Times, Strong Men',type:'Improvisor',aff:'expanded_worlds',
    fate:3,cost:2,rarity:'triangle',
    effect:'At any time during your turn, you can activate this effect; The next card you draw gains 7 Fate Permanently (2 uses).',
    flavor:'"Leader of an elite mercenary group who patrols the wastes of Temecula, purging it of zombie hordes"',img:'40.png?v=20260909-balance'},
  ...
  {id:'61',name:'Maria Song',ability:'Precise Shot',type:'Dauntless',aff:'eventide',
    ...
    effect:'When set, reveal all Character cards in your opponent\'s hand and select one. All copies of that card in their hand, deck, and on the field lose 9 Fate.',
    flavor:'"That giant cleaver is cool and all but what\'s the point if I just blow your brains out from over here?"',img:'61.png?v=20260909-balance'},
  ...
  {id:'64',name:'Cook Islands Duelist',ability:'Blade Dance',type:'Supporter',aff:'eventide',
    fate:1,cost:0,rarity:'circle',effectClass:null,
    effect:'When set, on the next Morale Damage Calculation, double the amount of Morale Damage you inflict.',
    flavor:'"Dueling takes a very ostentatious appearance in the Cook Islands, trading practicality for flashiness"',img:'64.png?v=20260830a'},
  {id:'66',name:'Mark Menz',ability:'Beyond Drawings',type:'Initiator',aff:'reality',
    ...
    flavor:'"Steph Curry... MY GOAT!"',img:'66.png?v=20260723a'},
  {id:'67',name:'Mr. Secules',ability:'"You Just Said Nothing"',type:'Improvisor',aff:'reality',
    ...
    flavor:'"Breathe. Relax your shoulders. Unclench your jaw"',img:'67.png?v=20260829a'},
  ...
  {id:'69',name:'Breakfast Republic Busser',ability:'Corner! Behind!',type:'Supporter',aff:'reality',
    fate:1,cost:0,rarity:'circle',
    effect:'When set, pay 25 Morale to add any Initiator from the Discard to the hand.',
    flavor:'"May I take/grab/snag/ that Plate for you?"',img:'69.png?v=20260829a'},
  ...
  {id:'73',name:'ALPINE Expeditionary',ability:'Global Missions',type:'Supporter',aff:'expanded_worlds',
    ...
    flavor:'"Superior technology and equipment allows for these individuals to be dropped anywhere on earth and easily survive for years"',img:'73.png?v=20260830a'},
  ...
  {id:'87',name:'Kv\u011btka Svoboda (Ukulele)',ability:'A Noble Effort at a Ballad',type:'Initiator',aff:'expanded_worlds',
    ...
    flavor:'"Let me sing you a song! It goes like... em... ughhh... something... wow!"',img:'87.png?v=20260830a'},
  ...
  {id:'89',name:'Zsofia Szocs (Youth)',ability:'Terrible Twins: Diva',type:'Dauntless',aff:'expanded_worlds',
    fate:8,cost:2,rarity:'triangle',
    effect:'As long as you activate less than 10 Supporter effects this game, this card gains 8 Fate.',
    flavor:'"Ummm can you tell Rozsi to read somewhere else in the house? His aura is giving me bad skin..."',img:'89.png?v=20260909-youth-art'},
  ...
  {id:'91',name:'Wodny Potok Villager',ability:'A Snowy Village',type:'Supporter',aff:'expanded_worlds',
    fate:1,cost:0,rarity:'circle',
    effect:'When you would draw or add this card to your hand in any way, search your deck for any card other than Wodny Potok Villager whose effect involves a landscape, add it to your hand, and reduce its consolidation cost by 2.',
    flavor:'"Life in Wodny Potok is straight out of a children\'s Christmas novel"',img:'91.png?v=20260910-new-art'},
  ...
  {id:'95',name:'Carpathian Specters',ability:'Thousand Year Sorrow',type:'Supporter',aff:'expanded_worlds',
    fate:1,cost:0,rarity:'circle',
    effect:'For each of your Draw phases that passes from turn 14 onwards, this card gains 1 Fate permanently.',
    flavor:'"The shadows of those who fell in forgotten battles, condemned to an eternity of lamentation"',img:'95.png?v=20260908-draw'},
  {id:'96',name:'Wodny Potok Snow Shoveler',ability:'Shovel',type:'Supporter',aff:'expanded_worlds',
    fate:1,cost:0,rarity:'triangle',
  ...
  {id:'76',name:'ALPINE Infantry',ability:'Infiltration',type:'Supporter',aff:'expanded_worlds',
    ...
    flavor:'"A mere company of these futuristic soldiers could overthrow a small country"',img:'76.png?v=20260830a'},
  // Brave Horizons
  ...
  {id:'bh02',name:'Joie',ability:'Thousand Reel Stare',type:'Coordinator',aff:'reality',
    fate:1,cost:4,rarity:'square',set:'brave_horizons',
    effect:'Each time you would activate a draw effect, all cards you control in this zone gain 1 Fate.',
    flavor:'"You\'re so fake"',img:'bh2.png?v=20260823a'},
  {id:'bh03',name:'Ali, The Indomitable',ability:'He, Who is Unyielding',type:'Improvisor',aff:'expanded_worlds',
    fate:2,cost:3,rarity:'triangle',set:'brave_horizons',
  ...
  {id:'bh04',name:'Anicka Konvicka (Selva Island)',ability:'The Destruction of Paradise',type:'Initiator',aff:'eventide',
    ...
    flavor:'"Everything I do...its all to find Kazumi and bring her home"',img:'bh4.png?v=20260907-selva'},
  ...
  {id:'bh06',name:'Achille Laurent',ability:'Adaptive Tactics',type:'Initiator',aff:'third_great_war',
    ...
    flavor:'"The Swallow of France is known for his ability to adapt to any battlefield"',img:'bh6.png?v=20260830a'},
  {id:'bh07',name:'Agent-K',ability:'Overclock',type:'Coordinator',aff:'expanded_worlds',
    ...
    flavor:'"A prodigious talent in hacking and code breaking"',img:'bh7.png?v=20260830a'},
  {id:'bh08',name:'Maja Kaminska (University)',ability:'Mischievous Activities',type:'Coordinator',aff:'expanded_worlds',
    fate:4,cost:3,rarity:'square',set:'brave_horizons',
    effect:'Each time you would negate or suppress an opponent\'s card, all cards you control in this card\'s zone gain 2 Fate.',
    flavor:'"We shall draw silly faces on the Palace of Science and Culture"',img:'bh8.png?v=20260830b'},
  {id:'bh09',name:'Alondra Hopkins (Mercenary)',ability:'The Child of War',type:'Dauntless',aff:'eventide',
    fate:0,xFate:true,cost:3,rarity:'square',set:'brave_horizons',
    effect:'When set, select any zone—this card gains Fate equal to your total Fate in that zone subtracted by your opponent\'s total Fate in that zone.',
    flavor:'"From the moment I was born, I was never given a choice"',img:'bh9.png'},
  {id:'bh10',name:'Francisek',ability:'Chauffeur',type:'Initiator',aff:'expanded_worlds',
    fate:1,cost:2,rarity:'square',set:'brave_horizons',
    effect:'Open a card catalog with every Supporter in the game. Select one to add to your hand, and it does not count toward the Supporter limit.',
    flavor:'"A reliable chauffeur for the Janowicz family"',img:'bh10.png?v=20260912-redraw'},
  {id:'bh11',name:'Felicyta Janowicz (University)',ability:'Superior Marks',type:'Coordinator',aff:'expanded_worlds',
    fate:3,cost:2,rarity:'triangle',set:'brave_horizons',effectClass:'ADJACENCY_BONUS_MULTIPLIER',
    effect:'Double all adjacency bonuses you control in this card\'s zone.',
    flavor:'"Her arduous background in Political Science makes her a Superior Pupil"',img:'bh11.png'},
  {id:'bh12',name:'Louis LeJeune',ability:'The Flower King',type:'Coordinator',aff:'third_great_war',
    fate:1,cost:1,rarity:'triangle',set:'brave_horizons',effectClass:'ADJACENCY_BONUS',
    effect:'Choose a square adjacent to this card; while this card is on the field, any card you set on that square gains 6 Fate.',
    flavor:'"The only thing that man can rule is his own garden"',img:'bh12.png?v=20260823a'},
  {id:'bh13',name:'Hugh Roberts',ability:'Smart Investments',type:'Initiator',aff:'expanded_worlds',
    fate:1,cost:1,rarity:'triangle',set:'brave_horizons',
    effect:'Send up to three cards in your hand back into the Deck—each of those cards permanently gain 7 Fate.',
    flavor:'"He\'s slimy, shady, and unapologetically self-interested—the perfect type of man to run the finances of your top secret military facility in the Alps"',img:'bh13.png?v=20260909-seven'},
  ...
  {id:'bh16',name:'Li-Hua (Battle-Ready)',ability:'Storm of Ten Thousand Blades',type:'Improvisor',aff:'eventide',
    ...
    effect:'At any time, you can activate this effect—for every Eventide card you control, reduce your opponent\'s Zone Fate in this card\'s Zone by 1. (2 uses)',
    flavor:'"A furious dragon, amidst a raging typhoon—such is the impression left by Li-Hua\'s peerless bladework"',img:'bh16.png?v=20260830a'},
  {id:'bh17',name:'Jakob Eltzholtz',ability:'Crushing Momentum',type:'Improvisor',aff:'expanded_worlds',
    fate:6,cost:3,rarity:'triangle',set:'brave_horizons',
    effect:'When you would consolidate a card while you have more total Fate than your opponent, that card gains 3 Fate permanently.',
    flavor:'"The only time I felt genuine sadness in my entire life...was when those zombies tore down my Siggy\'s!"',img:'bh17.png?v=20260830a'},
  {id:'bh18',name:'Jimmy (Post-Cynthia Hug)',ability:'The Genesis of all Inceldom',type:'Improvisor',aff:'reality',
    fate:7,cost:3,rarity:'square',set:'brave_horizons',
    effect:'Whenever you would take Morale Damage from the Morale Calculation, reduce your opponent\'s Zone Fate in this zone by 3.',
    flavor:'"In that fleeting moment with Cynthia, at the pinnacle of his entire existence...Jimmy seethed."',img:'bh18.png?v=20260830a'},
  {id:'bh19',name:'Abed',ability:'High-T',type:'Initiator',aff:'reality',
    fate:2,cost:2,rarity:'square',set:'brave_horizons',
    effect:'For one turn, all permanent Fate gain effects are doubled in potency. This effect cannot be stacked.',
    flavor:'"Take Zinc and Magnesium"',img:'bh19.png?v=20260910a'},
  {id:'bh20',name:'Makenna (Bird Cult)',ability:'Thousand Year Bird Cult',type:'Initiator',aff:'expanded_worlds',
    fate:4,cost:1,rarity:'triangle',set:'brave_horizons',
    effect:'Extend the game by two turns.',
    flavor:'"While not based on racial superiority like other similarly styled Fascist Regimes, it does take quite an...avian character..."',img:'bh20.png?v=20260825a'},
  {id:'bh21',name:'Oktai',ability:'The Vast Taklamakan',type:'Initiator',aff:'expanded_worlds',
    fate:3,cost:2,rarity:'triangle',set:'brave_horizons',
    effect:'For the next four turns, your opponent can no longer see Fate values, Morale values, Hand Count, the Timer, the turn count, and Status Effect banners.',
    flavor:'"With me by your side, you only have a 10% chance of never making it out of here alive!"',img:'bh21.png?v=20260912a'},
  {id:'bh22',name:'Jaime',ability:'A Moonlit Shore',type:'Initiator',aff:'expanded_worlds',
    fate:5,cost:1,rarity:'triangle',set:'brave_horizons',
  ...
  {id:'bh23',name:'Panacea Militia',ability:'In Defense of Pacifica',type:'Supporter',aff:'eventide',
    fate:1,cost:0,rarity:'circle',set:'brave_horizons',
    effect:'When set, select a Coordinator in this card\'s zone with a triggered Fate-gain effect. This card permanently gains the total Fate it would have received from that Coordinator\'s previous triggers this game.',
    flavor:'"In defense of the Seas they love, ordinary Civilians will lay down their lives"',img:'bh23.png'},
  {id:'bh24',name:'Leningrad 4th Rifles',ability:'Defense in Depth',type:'Supporter',aff:'third_great_war',
    fate:1,cost:0,rarity:'circle',set:'brave_horizons',
    effect:'When set, pay 15 Morale. The next Supporter you set does not contribute to the ordinary Supporter set limit and gains 4 Fate. The global 5-per-turn Supporter cap still applies.',
    flavor:'"Remember the thing that worked the last World War? Let\'s run it back"',img:'bh24.png?v=20260831b'},
  {id:'bh25',name:'ALPINE Engineer',ability:'An Engineer\'s Ambition',type:'Supporter',aff:'expanded_worlds',
    fate:1,cost:0,rarity:'circle',set:'brave_horizons',
    effect:'This card\'s effect won\'t activate until at least turn 18. When set, this card triggers a proc for any effect that would involve Fate gain from a trigger condition on your field, as long as the target(s) is valid',
    flavor:'"Hey! Don\'t rush me! Infinite Energy takes time to discover, ya know"',img:'bh25.png'},
];
...
const ACHILLES_ADAPTIVE_TOKEN_DEFINITIONS = Object.freeze([
  ...
  Object.freeze({id:'token3',name:'Howard\'s Fit',ability:'Tried and True',type:'Token',aff:'reality',fate:2,cost:0,rarity:'circle',token:true,achillesToken:true,set:'brave_horizons',effect:'This card counts as a Token. Before placement, declare whether it was set or consolidated, its card type, rarity, and affiliation.',flavor:'"You can always trust an aura farmer to aura farm"',img:'token3.png'}),
  Object.freeze({id:'token4',name:'The Heart of the Sea',ability:'The Seas Beckon',type:'Token',aff:'reality',fate:2,cost:0,rarity:'circle',token:true,achillesToken:true,set:'brave_horizons',effect:'This card counts as a Token. Before placement, declare whether it was set or consolidated, its card type, rarity, and affiliation.',flavor:'"The waves, the wind, that blue expanse-they murmur of tales to be told"',img:'token4.png'}),
  Object.freeze({id:'token5',name:'Soviet Captain\'s Badge',ability:'Legacy of the Revolution',type:'Token',aff:'reality',fate:2,cost:0,rarity:'circle',token:true,achillesToken:true,set:'brave_horizons',effect:'This card counts as a Token. Before placement, declare whether it was set or consolidated, its card type, rarity, and affiliation.',flavor:'"Veterans of the Russian Revolution were prime candidates for the rank of Captain"',img:'token5.png'})
]);
...
const LANDSCAPES = {
  igb1: {
    ...
    description:'Fate differences in zones inflict no Morale Damage. Morale Damage from card effects is still inflicted.'
  },
  igb2: {
    id:'igb2',
  ...
  igb5: {
    ...
    description:'Whichever player has more total Fate, all cards they set gain 2 Fate.'
  },
  igb6: {
    id:'igb6',
  ...
  igb9: {
    ...
    description:'Once per effect that draws outside the Draw Phase, you may select any card on the field. It gains 3 Fate permanently.'
  },
  igb10: {
    id:'igb10',
  ...
  igb17: {
    ...
    description:'Once per game, discard a Coordinator you control. Add a 5 Fate Shizuku Token to your hand that copies that Coordinator\'s effect and applies it to your whole field. Some Coordinators are not eligible.'
  },
  igb18: {
    id:'igb18',
  ...
  igb21: {
    id:'igb21',
    name:'Moffitt Library: Whiteboard Drawings',
    shortName:'Whiteboard Drawings',
    description:'Once per game during your turn, open a catalog containing every non-Star card in the game and add up to 4 cards from it to your hand.'
  },
  igb22: {
    id:'igb22',
    name:'The Mexican Civil War, 2029: The Chihuahuan Desert',
    shortName:'The Chihuahuan Desert',
    description:'Two zones are selected at random. All cards consolidated into those zones cost 1 extra Reinforcement.'
  },
  igb23: {
    id:'igb23',
    name:'Pacifica Nights: The Shores of La Helena',
    shortName:'The Shores of La Helena',
    description:'All Morale costs required by card effects cost no Morale. At each Morale Calculation, each player recovers Morale equal to twice the number of cards in their hand.'
  },
  igb24: {
    id:'igb24',
    name:'The Moscow Protest, 2025: Dawn of a Revolution',
    shortName:'Dawn of a Revolution',
    description:'When Turn 20 begins, every Supporter that has been on the board for at least 10 turns gains 6 Fate permanently and becomes immune to your opponent\'s effects.'
  }
};
