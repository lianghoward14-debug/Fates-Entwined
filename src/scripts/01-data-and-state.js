...
const CARDS = [
  ...
  {id:'34',name:'Rozsi Szocs',ability:'Hungarian Dance',type:'Coordinator',aff:'third_great_war',
    ...
    flavor:'"Rozsi\'s charisma counterparts his sister\'s administrative abilities. Together, the Twin Monarchs are a capable duo"',img:'34.png?v=20260830a'},
  ...
  {id:'40',name:'Christopher Erbs',ability:'Hard Times, Strong Men',type:'Improvisor',aff:'expanded_worlds',
    ...
    flavor:'"Leader of an elite mercenary group who patrols the wastes of Temecula, purging it of zombie hordes"',img:'40.png?v=20260830a'},
