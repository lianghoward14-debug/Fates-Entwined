...
const CARDS = [
  ...
  {id:'95',name:'Carpathian Specters',ability:'Thousand Year Sorrow',type:'Supporter',aff:'expanded_worlds',
    ...
    flavor:'"The shadows of those who fell in forgotten battles, condemned to an eternity of lamentation"',img:'95.png?v=20260830a'},
  ...
  {id:'bh25',name:'ALPINE Engineer',ability:'An Engineer\'s Ambition',type:'Supporter',aff:'expanded_worlds',
    fate:1,cost:0,rarity:'circle',set:'brave_horizons',
    effect:'This card\'s effect cannot activate before turn 18. When set, trigger one proc of every valid conditional triggered Fate-gain effect on cards in this zone.',
