...
const CARDS = [
  ...
  {id:'bh20',name:'Makenna (Bird Cult)',ability:'Thousand Year Bird Cult',type:'Initiator',aff:'expanded_worlds',
    fate:4,cost:2,rarity:'triangle',set:'brave_horizons',
    effect:'Extend the game to turn 24.',
    flavor:'"While not based on racial superiority like other similarly styled Fascist Regimes, it does take quite an...avian character..."',img:'bh20.png?v=20260824a'},
