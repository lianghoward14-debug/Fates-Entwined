...
const CARDS = [
  ...
  {id:'bh12',name:'Louis LeJeune',ability:'The Flower King',type:'Coordinator',aff:'third_great_war',
    ...
    effect:'Choose a card adjacent to this card; while this card is on the field, that card gains 6 Fate.',
    flavor:'"The only thing that man can rule is his own garden"',img:'bh12.png'},
