...
const CARDS = [
  ...
  {id:'bh10',name:'Francisek',ability:'Chauffeur',type:'Initiator',aff:'expanded_worlds',
    fate:1,cost:3,rarity:'square',set:'brave_horizons',
    effect:'Open a card catalog with every Supporter in the game. Select one to add to your hand. Its next set does not count toward the ordinary Supporter limit, but still obeys the global Supporter cap. This is not a search effect.',
    flavor:'"A reliable chauffeur for the Janowicz family"',img:'bh10.png?v=20260911-catalog'},
