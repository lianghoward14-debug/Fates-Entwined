...
const AI_ONLY_RANDOM_DECKS = [
  ...
  },
  {
    ...
    "description": "Develop cheap search and draw, fund a single Chingachlook removal play, and use Jaime and recovery to sustain the Morale cost. Additional finishers are replacements, not a required three-card engine.",
  ...
  },
  {
    ...
    "description": "Build Alexander through affordable reinforcement and Isaac buffs. Howard is an optional finisher; Marines and Havano protect the pressure plan while South Wind buys a calculation.",
  ...
  },
  {
    ...
    "description": "Search Rozsi, develop a supporter formation, and use Mark Menz to unify its affiliation. Win through repeated pressure and disruptive supporters without requiring Duncan alongside the engine.",
  ...
  },
  {
    ...
    "description": "Search and recur Great Oak Infantry for direct Morale damage while cheap draw sustains the hand. Alexander adds a separate clock; Jaime and South Wind support selective recursion rather than unlimited Morale spending.",
  ...
  },
  {
    ...
    "description": "Develop a cheap supporter formation, then add Felicyta and University Felicyta when adjacency already offers value. Avoid the former multiple-Dauntless setup; interaction remains available throughout development.",
  ...
  },
  {
    ...
    "description": "Use Anicka to open discounted development, Louis to empower arrivals, and Jaime to turn one established safe-row threat into recovery. Search Cathy when the character formation supports her aura.",
  ...
  },
  {
    ...
    "description": "Develop real reinforcement before committing Alondra or Henry. Cheap initiators supply access and can later be recycled through Irvine; Ralph and United Nations support the expensive threats.",
  ...
  },
  {
    ...
    "description": "Build reinforcement and draw first, then activate the Ukulele sequence only when several consolidations are affordable. ALPINE Expeditionary and Isaac provide permanent gains without requiring multiple four-cost finishers.",
  ...
  },
  {
    ...
    "description": "Use immutable ALPINE Infantry for immediate zone pressure and Berkeley denial to protect tempo. Other supporters fund cheap characters; ALPINE Infantry is never counted as reinforcement or a buff target.",
  ...
  },
  {
    ...
    "description": "Establish Anne-led supporters, then use Alondra selectively to close contested lanes. Colombo and Berkeley attack opposing development; affordable access replaces the separate Chingachlook package.",
  ...
  },
  {
    ...
    "description": "Combine Ali hand pressure with theft, Guerilla filtering and cheap negation. Kazumi and Jorge sustain access; win through board development while disrupting the opponent rather than filling the deck with slow hand attacks.",
  ...
  },
  {
    ...
    "description": "Use Lina to set Joie directly from deck or discard. Establish a populated zone before chaining draw effects; Panacea cashes in past triggers, while Hsei-Ling is optional rather than another prerequisite.",
  ...
  },
  {
    ...
    "description": "Use cheap access to find Selva Anicka for a board-breaking reduction when targets justify the cost. Li-Hua is a secondary Eventide payoff; supporter denial buys time without demanding a large character assembly.",
  ...
  },
  {
    ...
    "name": "Crown of Five",
    "description": "Build a supporter-funded Coordinator court with Kvetka, Zsofia and Duncan. High Schooler finds the needed aura; the deck no longer requires five different expensive Coordinators to become functional.",
  ...
  },
  {
    ...
    "description": "Find Jimmy through Lina and Wodny Potok Youth through supporter search. Repeated Snowball activations and Fusilier copies grow Jimmy while weakening opposing formations; Taylor supplies flexible access or redundancy.",
  ...
  },
  {
    ...
    "description": "Develop an affordable board before changing to Snow. Youth Rozsi enables the Blame Game conversion; convert established supporters into character reinforcement for Wintertide, with Kvetka supplying a separate free Expanded Worlds character route.",
