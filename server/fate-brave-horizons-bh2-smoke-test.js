...
assert.match(index, /01-data-and-state\.js\?v=1785023060[\s\S]*04-game-setup\.js\?v=1785023110[\s\S]*05-gameplay-core\.js\?v=1785023100[\s\S]*04-match-renderer-adapter\.js\?v=1785023022[\s\S]*07-ai\.js\?v=1785023021[\s\S]*08-audio-and-meta-ui\.js\?v=1785023070/, 'BH2 runtime surfaces must be cache-busted');
