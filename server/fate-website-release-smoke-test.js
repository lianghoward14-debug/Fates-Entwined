...
assert.match(html, /109-card catalog[\s\S]*Twenty Landscapes[\s\S]*All 109 current catalog entries/, 'website copy must describe the current catalog and landscape count');
