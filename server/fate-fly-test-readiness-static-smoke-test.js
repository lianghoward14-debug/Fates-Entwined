...
assert.match(authorityText, /pathname === '\/src\/scripts\/18-online-rooms\.js'[\s\S]*return ''/, 'authority server must not let persisted static overrides mask online room authority code');
