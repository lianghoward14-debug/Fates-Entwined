...
assert.match(indexText, /05-gameplay-core\.js\?v=1782615600/, 'index must cache-bust gameplay consolidation fixes');
assert.match(indexText, /06-rendering-and-helpers\.js\?v=1782601200/, 'index must cache-bust renderer extra-cell fixes');
assert.match(indexText, /03-profile-and-progression\.js\?v=1782616800/, 'index must cache-bust daily login startup prompt fixes');
assert.match(indexText, /18-online-rooms\.js\?v=1782616800/, 'index must cache-bust the online rooms script for client-resolved gameplay');
assert.match(indexText, /09-challenger-mode\.js\?v=1782616800/, 'index must cache-bust the challenger leaderboard, simulation, social filtering, and profile crop script');
assert.match(indexText, /17-online-social\.js\?v=1782616200/, 'index must cache-bust the online social script for internal-player filtering');
assert.match(indexText, /04-game-setup\.js\?v=1782616800/, 'index must cache-bust the match setup script for multiplayer coin flip, draw animation, and profile crop fixes');
assert.match(indexText, /16-online-core\.js\?v=1782616800/, 'index must cache-bust the shared online profile crop helper');
assert.match(indexText, /22-spectator\.js\?v=1782616800/, 'index must cache-bust spectator profile crop fixes');
assert.match(indexText, /render-v2\/04-match-renderer-adapter\.js\?v=1782616800/, 'index must cache-bust render-v2 pending effect visibility fixes');
assert.match(indexText, /19-online-elo\.js\?v=1782615600/, 'index must cache-bust the online ELO script for full-pair Fly Challenger AI fixes');
