...
assert.match(indexText, /18-online-rooms\.js\?v=1782609000/, 'index must cache-bust the online rooms script for client-resolved gameplay');
...
assert.match(roomsText, /function needsAuthorityCatchupBeforeLocal\(\)\{\s*return false;\s*\}/, 'strict Fly actions must not wait for HTTP replay catch-up before local clicks');
