(function(){
  ...
  function buildProductionBoardMetrics(vp, opts){
    ...
    const zonePadX = Number.isFinite(opts.zonePadX) ? opts.zonePadX : rem * 0.52;
    ...
    return {
      ...
      boardGap,
      zonePadX,
      zonePadTop:Number.isFinite(opts.zonePadTop) ? opts.zonePadTop : rem * 1.66,
      zonePadBottom:Number.isFinite(opts.zonePadBottom) ? opts.zonePadBottom : rem * 1.02,
      ...
      zoneVerticalAlign:Number.isFinite(opts.zoneVerticalAlign) ? opts.zoneVerticalAlign : 0.10,
      zoneFitW
    };
  }
