...
const CARD_RULES = [
  ...
  card('bh19','Abed','WHEN_SET','CONTROLLER','ALL_POSITIVE_PERMANENT_FATE_GAIN_EFFECTS_THIS_TURN','For the rest of this owner turn, each active High-T status adds one extra copy of the original permanent Fate gain; copies stack additively and never compound prior bonuses.',{forbidden:['EXPONENTIAL_DOUBLING','FATE_LOSS_DOUBLED','STATUS_SURVIVES_OWNER_TURN_END']}),
