...
const CARD_RULES = [
  ...
  card('bh25','ALPINE Engineer','WHEN_SET','ALL','VALID_CONDITIONAL_TRIGGERED_FATE_SOURCES_IN_SOURCE_ZONE','At turn 18 or later, proc each valid conditional triggered Fate-gain effect in this card\'s zone once. Present the Engineer overlay on every triggered source card. Fate-gain modifiers do not count as source triggers, and effects requiring a presently nonexistent target do not proc.',{forbidden:['ACTIVATES_BEFORE_TURN_18','SOURCE_OUTSIDE_ENGINEER_ZONE','HSEI_LING_MODIFIER_PROCS','JAKOB_WITHOUT_CONSOLIDATED_TARGET_PROCS','OVERLAY_ON_ENGINEER_INSTEAD_OF_TRIGGERED_SOURCE']})
];
