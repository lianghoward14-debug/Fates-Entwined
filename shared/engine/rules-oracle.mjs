...
const CARD_RULES = [
  ...
  card('bh20','Makenna (Bird Cult)','WHEN_SET','CONTROLLER','MATCH_TURN_LIMIT','When set, extend the match turn limit to turn 24. Never reduce a turn limit that is already higher.',{forbidden:['TURN_LIMIT_BELOW_24','TURN_LIMIT_REDUCED','MORE_THAN_ONE_USE']}),
