...
const CARD_RULES = [
  ...
  card('02','Anicka Konvicka',['WHEN_SET','PASSIVE'],'CONTROLLER','SOURCE_ZONE','Create exactly one full four-square extra safe row owned by Anicka’s controller in her zone; every card placed in that zone gains exactly +4 effective Fate, and a card consolidated into Anicka’s generated row costs exactly 2 less Reinforcement.',{stateEvidence:['SAFE_ROW_ADDED.playerIndex_EQUALS_SOURCE_CONTROLLER','FOUR_PLAYABLE_EXTRA_SQUARES_HAVE_SOURCE_CONTROLLER','ROW_OWNER_IDENTICAL_IN_BOTH_SEAT_PROJECTIONS','ZONE_PLACEMENT_BONUS_IS_PLUS_4','ANICKA_ROW_REINFORCEMENT_COST_MINUS_2'],forbidden:['SAFE_ROW_ASSIGNED_TO_OPPONENT','VIEWER_INDEX_CHANGES_ROW_OWNER','COST_REDUCTION_OUTSIDE_ANICKA_ROW','COST_REDUCTION_EXCEEDS_2','ANICKA_QUALIFIES_AS_A_NEW_PLACEMENT_MORE_THAN_ONCE']}),
