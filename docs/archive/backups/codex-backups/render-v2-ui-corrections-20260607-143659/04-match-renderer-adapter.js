(function(){
  ...
  function drawCommandDock(ctx, hitMap, snapshot, cssW, cssH){
    ...
    ctx.stroke();
    ctx.beginPath();
    ctx.arc(sealCx, sealCy, sealR - 11, -Math.PI * .72, Math.PI * .72);
    ctx.strokeStyle = canEndTurn ? 'rgba(255,222,92,.30)' : 'rgba(210,210,204,.10)';
    ctx.lineWidth = 3.1;
    ctx.lineCap = 'round';
    ctx.stroke();
    ctx.save();
    ...
    ctx.strokeStyle = canEndTurn ? 'rgba(255,239,147,.88)' : 'rgba(220,220,212,.32)';
    ctx.lineWidth = 1.35;
    ctx.beginPath();
    ctx.rect(-8, -8, 16, 16);
    ctx.stroke();
    ...
    ctx.lineTo(-5, 0);
    ctx.lineTo(-13, 7);
    ctx.strokeStyle = canEndTurn ? 'rgba(255,239,147,.42)' : 'rgba(220,220,212,.18)';
    ctx.lineWidth = 1.8;
    ctx.lineCap = 'round';
    ctx.lineJoin = 'round';
    ctx.stroke();
