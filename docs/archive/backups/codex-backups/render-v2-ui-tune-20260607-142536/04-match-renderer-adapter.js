(function(){
  ...
  function drawCommandDock(ctx, hitMap, snapshot, cssW, cssH){
    ...
    sealGrad.addColorStop(.32, canEndTurn ? 'rgba(201,151,42,.96)' : 'rgba(62,66,72,.80)');
    sealGrad.addColorStop(.66, canEndTurn ? 'rgba(30,36,35,.98)' : 'rgba(31,33,38,.92)');
    ...
    ctx.strokeStyle = canEndTurn ? 'rgba(255,246,188,.30)' : 'rgba(210,210,204,.16)';
    ctx.lineWidth = 1.1;
    ctx.stroke();
    ctx.beginPath();
    ctx.arc(sealCx, sealCy, sealR - 15, 0, Math.PI * 2);
    ctx.strokeStyle = canEndTurn ? 'rgba(255,222,92,.18)' : 'rgba(210,210,204,.10)';
    ctx.lineWidth = 5;
    ctx.stroke();
    ctx.save();
    ctx.translate(sealCx, sealCy);
    ctx.fillStyle = canEndTurn ? 'rgba(255,239,147,.94)' : 'rgba(220,220,212,.38)';
    ctx.beginPath();
    ctx.moveTo(-8, -12);
    ctx.lineTo(12, 0);
    ctx.lineTo(-8, 12);
    ...
    ctx.lineTo(-2, 0);
    ctx.lineTo(-14, 10);
    ctx.strokeStyle = canEndTurn ? 'rgba(255,239,147,.46)' : 'rgba(220,220,212,.20)';
    ctx.lineWidth = 2.1;
    ctx.lineCap = 'round';
    ctx.lineJoin = 'round';
    ctx.stroke();
