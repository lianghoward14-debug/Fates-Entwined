...
| --- | --- | --- |
| Phase 0: Architecture and Rule Inventory | Complete | All 114 cards and 20 landscapes have machine-checked operation/modifier/trigger/custom-handler assignments. The observe-only recorder and ambiguity ledger pass `smoke:authority-v3-phase0`. |
...
| Phase 4: Card Families | Complete | All 114 cards and all 20 landscapes have isolated implementations. Deterministic, interactive, triggered, timer-owned, token-copying, and landscape-changing rules pass the complete Phase 4 aggregate. |
...
- `docs/AUTHORITY_V3_PHASE0_RULE_INVENTORY.json` inventories all 114 playable
...
- `smoke:authority-v3-phase4` runs every Phase 4 family and the completed
  114-card/20-landscape registry. No later phase is promoted.
