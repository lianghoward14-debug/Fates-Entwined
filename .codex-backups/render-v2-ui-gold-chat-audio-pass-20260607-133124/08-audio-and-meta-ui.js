...
function showAudioSettings() {
  ...
  showModal('Audio',`
    <div style="text-align:center;margin-bottom:.2rem;">
      <div style="font-size:.88rem;margin-bottom:.04rem;">🔊</div>
      <div style="font-family:'Cinzel',serif;font-size:.55rem;color:var(--gold);letter-spacing:.1em;text-transform:uppercase;">Audio</div>
    </div>
    <div style="display:flex;flex-direction:column;gap:.24rem;align-items:center;max-width:138px;margin:0 auto;">
      <div style="text-align:center;width:100%;">
        <div style="font-family:'Cinzel',serif;font-size:.42rem;color:var(--dim);letter-spacing:.08em;text-transform:uppercase;margin-bottom:.04rem;">Master</div>
        <input type="range" min="0" max="100" value="${av}" style="width:110px;" oninput="setMasterVolume(this.value)">
      </div>
      <div style="text-align:center;width:100%;">
        <div style="font-family:'Cinzel',serif;font-size:.42rem;color:var(--dim);letter-spacing:.08em;text-transform:uppercase;margin-bottom:.04rem;">Music</div>
        <input type="range" min="0" max="100" value="${mv}" style="width:110px;" oninput="setMusicVolume(this.value)">
      </div>
      <div style="text-align:center;width:100%;">
        <div style="font-family:'Cinzel',serif;font-size:.42rem;color:var(--dim);letter-spacing:.08em;text-transform:uppercase;margin-bottom:.04rem;">Effects</div>
        <input type="range" min="0" max="100" value="${sv}" style="width:110px;" oninput="setSfxVolume(this.value)">
      </div>
      <div style="text-align:center;width:100%;">
        <div style="font-family:'Cinzel',serif;font-size:.42rem;color:var(--dim);letter-spacing:.08em;text-transform:uppercase;margin-bottom:.04rem;">Voices</div>
        <input type="range" min="0" max="100" value="${vv}" style="width:110px;" oninput="setVoiceVolume(this.value)">
      </div>
      <button class="btn sm" id="music-toggle-btn" data-music-toggle="1" onclick="toggleMusic()" style="margin-top:.22rem;min-height:24px;padding:.24rem .62rem;">${_musicEnabled?'Music On':'Music Off'}</button>
  ...
  if(modalEl) {
    ...
    modalEl.style.setProperty('width', '218px', 'important');
    modalEl.style.setProperty('max-width', '218px', 'important');
    modalEl.style.setProperty('min-width', '0', 'important');
    modalEl.style.setProperty('min-height', '0', 'important');
    modalEl.style.setProperty('padding', '.52rem .58rem', 'important');
  ...
  if(bodyEl) {
    bodyEl.style.setProperty('width', '156px', 'important');
